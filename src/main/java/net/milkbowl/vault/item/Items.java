...
public class Items {
    ...
    static {
        ...
        items.add(new ItemInfo(new String[][]{{"drag", "brea"}}, Material.DRAGONS_BREATH));
        items.add(new ItemInfo(new String[][]{{"beet", "bloc"}}, Material.BEETROOT_BLOCK));
        items.add(new ItemInfo(new String[][]{{"elyt"}}, Material.ELYTRA));
        items.add(new ItemInfo(new String[][]{{"shie"}}, Material.SHIELD));
        items.add(new ItemInfo(new String[][]{{"spru", "boa"}}, Material.BOAT_SPRUCE));
        items.add(new ItemInfo(new String[][]{{"jung", "boa"}}, Material.BOAT_JUNGLE));
        items.add(new ItemInfo(new String[][]{{"acac", "boa"}}, Material.BOAT_ACACIA));
        items.add(new ItemInfo(new String[][]{{"dark", "oak", "boa"}}, Material.BOAT_DARK_OAK));
        items.add(new ItemInfo(new String[][]{{"birc", "boa"}}, Material.BOAT_BIRCH));
        items.add(new ItemInfo(new String[][]{{"oak", "boat"}, {"boat"}}, Material.BOAT)); //Original boat is now called an Oak Boat, mat name hasnt changed.
        items.add(new ItemInfo(new String[][] {{"spec", "arrow"}}, Material.SPECTRAL_ARROW));
        items.add(new ItemInfo(new String[][] {{"tipp", "arrow"}}, Material.TIPPED_ARROW));
        items.add(new ItemInfo(new String[][] {{"spla", "poti"}}, Material.SPLASH_POTION));
        items.add(new ItemInfo(new String[][] {{"linger", "poti"}}, Material.LINGERING_POTION));
        ...
        items.add(new ItemInfo(new String[][] {{"poti", "mund", "spl"}}, Material.POTION, (short) 16384));
        items.add(new ItemInfo(new String[][] {{"poti", "rege", "spl"}}, Material.POTION, (short) 16385));
        items.add(new ItemInfo(new String[][] {{"poti", "rege", "spl", "ext"}}, Material.POTION, (short) 16449));
        items.add(new ItemInfo(new String[][] {{"poti", "rege", "spl", "2"}, {"poti", "rege", "spl", "ii"}}, Material.POTION, (short) 16417));
        items.add(new ItemInfo(new String[][] {{"poti", "swif", "spl"}, {"poti", "speed", "spl"}}, Material.POTION, (short) 16386));
        items.add(new ItemInfo(new String[][] {{"poti", "swif", "spl", "ext"}, {"poti", "speed", "spl", "ext"}}, Material.POTION, (short) 16450));
        items.add(new ItemInfo(new String[][] {{"poti", "swif", "spl", "2"}, {"poti", "swif", "spl", "ii"}, {"poti", "speed", "spl", "2"}, {"poti", "speed", "spl", "ii"}}, Material.POTION, (short) 16418));
        items.add(new ItemInfo(new String[][] {{"poti", "fire", "spl"}}, Material.POTION, (short) 16387));
        items.add(new ItemInfo(new String[][] {{"poti", "fire", "spl", "ext"}}, Material.POTION, (short) 16451));
        items.add(new ItemInfo(new String[][] {{"poti", "fire", "spl", "rev"}}, Material.POTION, (short) 16419));
        items.add(new ItemInfo(new String[][] {{"poti", "heal", "spl"}}, Material.POTION, (short) 16389));
        items.add(new ItemInfo(new String[][] {{"poti", "heal", "spl", "rev"}}, Material.POTION, (short) 16453));
        items.add(new ItemInfo(new String[][] {{"poti", "heal", "spl", "2"}, {"poti", "heal", "spl", "ii"}}, Material.POTION, (short) 16421));
        items.add(new ItemInfo(new String[][] {{"poti", "str", "spl"}}, Material.POTION, (short) 16393));
        items.add(new ItemInfo(new String[][] {{"poti", "str", "spl", "ext"}}, Material.POTION, (short) 16457));
        items.add(new ItemInfo(new String[][] {{"poti", "str", "spl", "2"}, {"poti", "str", "spl", "ii"}}, Material.POTION, (short) 16425));
        items.add(new ItemInfo(new String[][] {{"poti", "pois", "spl"}}, Material.POTION, (short) 16388));
        items.add(new ItemInfo(new String[][] {{"poti", "pois", "spl", "ext"}}, Material.POTION, (short) 16452));
        items.add(new ItemInfo(new String[][] {{"poti", "pois", "spl", "2"}, {"poti", "pois", "spl", "ii"}}, Material.POTION, (short) 16420));
        items.add(new ItemInfo(new String[][] {{"poti", "weak", "spl"}}, Material.POTION, (short) 16392));
        items.add(new ItemInfo(new String[][] {{"poti", "weak", "spl", "ext"}}, Material.POTION, (short) 16456));
        items.add(new ItemInfo(new String[][] {{"poti", "weak", "spl", "rev"}}, Material.POTION, (short) 16424));
        items.add(new ItemInfo(new String[][] {{"poti", "slow", "spl"}}, Material.POTION, (short) 16394));
        items.add(new ItemInfo(new String[][] {{"poti", "slow", "spl", "ext"}}, Material.POTION, (short) 16458));
        items.add(new ItemInfo(new String[][] {{"poti", "slow", "spl", "rev"}}, Material.POTION, (short) 16426));
        items.add(new ItemInfo(new String[][] {{"poti", "harm", "spl"}}, Material.POTION, (short) 16396));
        items.add(new ItemInfo(new String[][] {{"poti", "harm", "spl", "rev"}}, Material.POTION, (short) 16460));
        items.add(new ItemInfo(new String[][] {{"poti", "harm", "spl", "2"}, {"poti", "harm", "spl", "ii"}}, Material.POTION, (short) 16428));
        //
        items.add(new ItemInfo(new String[][]{{"air"}}, Material.AIR));
        items.add(new ItemInfo(new String[][]{{"ston"}, {"smoo", "sto"}}, Material.STONE));
        items.add(new ItemInfo(new String[][]{{"gras"}}, Material.GRASS));
        items.add(new ItemInfo(new String[][]{{"dirt"}}, Material.DIRT));
        items.add(new ItemInfo(new String[][]{{"cobb", "sto"}, {"cobb"}}, Material.COBBLESTONE));
        items.add(new ItemInfo(new String[][]{{"wood"}, {"oak", "plank"}, {"oak", "wood"}}, Material.WOOD));
        items.add(new ItemInfo(new String[][]{{"spru", "plank"}, {"spruc", "wood"}}, Material.WOOD, (short) 1));
        items.add(new ItemInfo(new String[][]{{"birch", "plank"}, {"birch", "wood"}}, Material.WOOD, (short) 2));
        items.add(new ItemInfo(new String[][]{{"jung", "plank"}, {"jung", "wood"}}, Material.WOOD, (short) 3));
        items.add(new ItemInfo(new String[][]{{"sapl"}, {"sapl", "oak"}}, Material.SAPLING));
        items.add(new ItemInfo(new String[][]{{"sapl", "spruc"}}, Material.SAPLING, (short) 1));
        items.add(new ItemInfo(new String[][]{{"sapl", "birch"}}, Material.SAPLING, (short) 2));
        items.add(new ItemInfo(new String[][]{{"sapl", "jungle"}}, Material.SAPLING, (short) 3));
        items.add(new ItemInfo(new String[][]{{"rock"}}, Material.BEDROCK));
        items.add(new ItemInfo(new String[][]{{"water"}}, Material.WATER));
        items.add(new ItemInfo(new String[][]{{"lava"}}, Material.LAVA));
        items.add(new ItemInfo(new String[][]{{"sand"}}, Material.SAND));
        items.add(new ItemInfo(new String[][]{{"ore", "gold"}}, Material.GOLD_ORE));
        items.add(new ItemInfo(new String[][]{{"ore", "iron"}}, Material.IRON_ORE));
        items.add(new ItemInfo(new String[][]{{"ore", "coal"}}, Material.COAL_ORE));
        items.add(new ItemInfo(new String[][]{{"grav"}}, Material.GRAVEL));
        items.add(new ItemInfo(new String[][]{{"oak"}, {"log"}, {"oak", "log"}}, Material.LOG));
        items.add(new ItemInfo(new String[][]{{"spruc"}, {"spruc", "log"}}, Material.LOG, (short) 1));
        items.add(new ItemInfo(new String[][]{{"birch"}, {"birch", "log"}}, Material.LOG, (short) 2));
        items.add(new ItemInfo(new String[][]{{"jung", "log"}}, Material.LOG, (short) 3));
        items.add(new ItemInfo(new String[][]{{"blo", "leaf"}, {"blo", "leaves"}}, Material.LEAVES));
        items.add(new ItemInfo(new String[][]{{"blo", "lea", "spruc"}}, Material.LEAVES, (short) 1));
        items.add(new ItemInfo(new String[][]{{"blo", "lea", "birch"}}, Material.LEAVES, (short) 2));
        items.add(new ItemInfo(new String[][]{{"blo", "lea", "jung"}}, Material.LEAVES, (short) 3));
        items.add(new ItemInfo(new String[][]{{"leaf"}, {"leaves"}}, Material.LEAVES, (short) 4));
        items.add(new ItemInfo(new String[][]{{"lea", "spruce"}}, Material.LEAVES, (short) 5));
        items.add(new ItemInfo(new String[][]{{"lea", "birch"}}, Material.LEAVES, (short) 6));
        items.add(new ItemInfo(new String[][]{{"lea", "jung"}}, Material.LEAVES, (short) 7));
        items.add(new ItemInfo(new String[][]{{"sponge"}}, Material.SPONGE));
        items.add(new ItemInfo(new String[][]{{"glas"}, {"sili"}}, Material.GLASS));
        items.add(new ItemInfo(new String[][]{{"lap", "laz", "ore"}, {"lazul", "ore"}, {"ore", "lapiz"}}, Material.LAPIS_ORE));
        items.add(new ItemInfo(new String[][]{{"lap", "laz", "bloc"}, {"lazu", "bloc"}, {"blo", "lapi"}}, Material.LAPIS_BLOCK));
        items.add(new ItemInfo(new String[][]{{"dispen"}}, Material.DISPENSER));
        items.add(new ItemInfo(new String[][]{{"sand", "st"}}, Material.SANDSTONE));
        items.add(new ItemInfo(new String[][]{{"chis", "sand", "sto"}}, Material.SANDSTONE, (short) 1));
        items.add(new ItemInfo(new String[][]{{"smoo", "sand", "sto"}}, Material.SANDSTONE, (short) 2));
        items.add(new ItemInfo(new String[][]{{"note"}}, Material.NOTE_BLOCK));
        items.add(new ItemInfo(new String[][]{{"block", "bed"}}, Material.BED_BLOCK));
        items.add(new ItemInfo(new String[][]{{"rail", "pow"}, {"trac", "pow"}, {"boost"}}, Material.POWERED_RAIL));
        items.add(new ItemInfo(new String[][]{{"rail", "det"}, {"trac", "det"}, {"detec"}}, Material.DETECTOR_RAIL));
        items.add(new ItemInfo(new String[][]{{"stic", "pis"}}, Material.PISTON_STICKY_BASE));
        items.add(new ItemInfo(new String[][]{{"web"}, {"cobw"}}, Material.WEB));
        items.add(new ItemInfo(new String[][]{{"dead", "shru"}, {"dese", "shru"}, {"shrub"}}, Material.LONG_GRASS, (short) 0));
        items.add(new ItemInfo(new String[][]{{"tall", "gras"}, {"long", "gras"}}, Material.LONG_GRASS, (short) 1));
        items.add(new ItemInfo(new String[][]{{"fern"}}, Material.LONG_GRASS, (short) 2));
        items.add(new ItemInfo(new String[][]{{"pisto"}}, Material.PISTON_BASE));
        items.add(new ItemInfo(new String[][]{{"wool", "whit"}, {"wool"}}, Material.WOOL));
        items.add(new ItemInfo(new String[][]{{"wool", "ora"}}, Material.WOOL, (short) 1));
        items.add(new ItemInfo(new String[][]{{"wool", "mag"}}, Material.WOOL, (short) 2));
        items.add(new ItemInfo(new String[][]{{"wool", "lig", "blue"}}, Material.WOOL, (short) 3));
        items.add(new ItemInfo(new String[][]{{"wool", "yell"}}, Material.WOOL, (short) 4));
        items.add(new ItemInfo(new String[][]{{"wool", "lig", "gree"}, {"wool", "gree"}}, Material.WOOL, (short) 5));
        items.add(new ItemInfo(new String[][]{{"wool", "pink"}}, Material.WOOL, (short) 6));
        items.add(new ItemInfo(new String[][]{{"wool", "gray"}, {"wool", "grey"}}, Material.WOOL, (short) 7));
        items.add(new ItemInfo(new String[][]{{"lig", "wool", "gra"}, {"lig", "wool", "gre"}}, Material.WOOL, (short) 8));
        items.add(new ItemInfo(new String[][]{{"wool", "cya"}}, Material.WOOL, (short) 9));
        items.add(new ItemInfo(new String[][]{{"wool", "pur"}}, Material.WOOL, (short) 10));
        ...
        **/
        ...
        items.add(new ItemInfo(new String[][]{{"ladd"}}, Material.LADDER));
        items.add(new ItemInfo(new String[][]{{"rail"}, {"trac"}}, Material.RAILS));
        items.add(new ItemInfo(new String[][]{{"stair", "cob", "sto"}, {"stair", "cob"}}, Material.COBBLESTONE_STAIRS));
